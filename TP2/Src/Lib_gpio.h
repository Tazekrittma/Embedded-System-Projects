...
/**
 * @brief  Creates a delay loop
 * @param  d: Long value of delay
 * @retval None
 */
...
/**
 * @brief  Writes GPIO port low byte
 * @param  GPIOx: Pointer to GPIOx port to be used
 * @param  LowVal: low byte to be written on the port
 * @retval None
 */
void GPIO_Writelow(GPIO_TypeDef* GPIOx, uint8_t LowVal);

/**
 * @brief  Writes GPIO port high byte
 * @param  GPIOx: Pointer to GPIOx port to be used
 * @param  HighVal: high byte to be written on the port
 * @retval None
 */
